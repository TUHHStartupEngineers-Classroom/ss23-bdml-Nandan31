...
# Read the Data
```{r}
employee_attrition_tbl <- read_csv("C:/Users/srajs/OneDrive/Desktop/Business/Business Decisions with Machine Learning/WA_Fn-UseC_-HR-Employee-Attrition.csv")
definitions_raw_tbl    <- read_excel("C:/Users/srajs/OneDrive/Desktop/Business/Business Decisions with Machine Learning/data_definitions.xlsx", sheet = 1, col_names = FALSE)
```
# Processing Pipeline
```{r}
...
automl_leader <- h2o.loadModel("C:/Users/srajs/OneDrive/Desktop/Business/Business Decisions with Machine Learning/h20models/StackedEnsemble_AllModels_3_AutoML_2_20230517_140427")
automl_leader
